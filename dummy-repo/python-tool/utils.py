...
# SECURITY FIX: Simplified regex to avoid ReDoS
...
# SECURITY FIX: Simplified regex to avoid catastrophic backtracking
...
# SECURITY FIX: Refactored to reduce cognitive complexity
