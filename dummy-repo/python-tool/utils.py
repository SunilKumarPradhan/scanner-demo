...
def connect_to_server():
    ...
    HOST = os.environ.get("SERVER_HOST", "192.168.1.100")
    USERNAME = os.environ.get("SERVICE_USERNAME", "service_account")
    PASSWORD = os.environ.get("SERVICE_PASSWORD", "service_password_2024")
    API_KEY = os.environ.get("SERVICE_API_KEY", "sk-api-key-12345-abcdef")
