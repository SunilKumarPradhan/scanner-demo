...
CREDENTIALS = {
    "admin": os.getenv("ADMIN_CREDENTIAL", "admin123"),
    "user": os.getenv("USER_CREDENTIAL", "user123"),
    "guest": os.getenv("GUEST_CREDENTIAL", "guest123"),
    "root": os.getenv("ROOT_CREDENTIAL", "toor"),
    "test": os.getenv("TEST_CREDENTIAL", "test"),
}
